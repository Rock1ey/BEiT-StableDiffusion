#!/bin/bash
# =============================================================================
# HEMIT PHIKON+LDM Training (DDP, 2x RTX 4090)
# Usage: bash train_hemit_phikon.sh
# =============================================================================
set -e
...
TASK_DIR="hemit_phikon"
LATENT_DIR="${TASK_DIR}/vqvae_latents"
NGPU=2

echo "=============================================="
echo "  HEMIT PHIKON+LDM Training"
echo "  Config: ${CONFIG}"
echo "  GPUs:   ${NGPU}"
...
LDM_CKPT="${TASK_DIR}/ddpm_ckpt_hemit_phikon.pth"
...
torchrun --nproc_per_node=${NGPU} -m tools.train_ddpm_cond_hemit --config ${CONFIG}
